...
def test_user_skill_cannot_omit_manifest_governance_for_protected_tool(tmp_path):
    tool_registry, plan_validator = _registry_and_validator(tmp_path)
    template = parse_skill_template(
        _skill_data(
            id="protected_adoption",
            steps=[
                {
                    "title": "Adopt",
                    ...
                    "inputs": {
                        ...
                        "adoption_reason": "Reviewed by the strategy owner",
                    },
                    "depends_on": [],
                    "post_checks": [],
                }
    ...
    assert validate_skill_template(template, tool_registry, plan_validator) == []
