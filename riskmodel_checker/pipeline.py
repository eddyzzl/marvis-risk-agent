...
from riskmodel_checker.notebook_cancellation import (
    NotebookCancelled,
    NotebookCancellationToken,
    register_notebook_cancellation,
    unregister_notebook_cancellation,
)
from riskmodel_checker.notebook_contract import RuntimeContract, load_runtime_contract
...
def _append_injected_cells(
    ...
    return [
        (
            ...
            append_code_cell(
                source,
                metadata={"riskmodel_checker": kind},
    ...
    *,
    ...
    if cell_index is not None and callable(execute_existing_code_cell):
        ...
        result = session.execute_code_cell(
            source,
            log_path=log_path,
            metadata={"riskmodel_checker": metadata_kind},
            record_progress=True,
        )
...
def _build_reproducibility_cell_sources(
    *,
    ...
    pmml_lines = [
        "# Injected by riskmodel_checker v3 (reproducibility evidence).",
        *_notebook_package_prelude(package_root),
        ...
        "from riskmodel_checker.validation.config import ValidationConfig as _RmcValidationConfig",
        "from riskmodel_checker.validation.in_memory_scores import load_code_model_scores as _rmc_load_code_model_scores",
        "from riskmodel_checker.validation.pmml_scoring import load_pmml_scorer as _rmc_load_pmml_scorer",
        "from riskmodel_checker.validation.reproducibility import _code_scores_by_row_index as _rmc_code_scores_by_row_index",
    ...
    compare_lines = [
        "# Injected by riskmodel_checker v3 (reproducibility compare).",
        *_notebook_package_prelude(package_root),
        "import json as _rmc_json",
        "from dataclasses import asdict as _rmc_asdict",
        "from pathlib import Path as _RmcPath",
        "from riskmodel_checker.validation.reproducibility import _nullable_score as _rmc_nullable_score",
        "from riskmodel_checker.validation.reproducibility import scores_match_at_precision as _rmc_scores_match_at_precision",
        "from riskmodel_checker.validation.results import ConsistencyStatus as _RmcConsistencyStatus",
        "from riskmodel_checker.validation.results import ConsistencySummary as _RmcConsistencySummary",
        "from riskmodel_checker.validation.results import ReproducibilityResult as _RmcReproducibilityResult",
        "from riskmodel_checker.validation.results import ScoreCompareRow as _RmcScoreCompareRow",
        f"_rmc_payload = {_json_literal(payload)}",
        "_rmc_rows = []",
        "_rmc_match_count = 0",
    ...
    *,
    ...
    prepare_lines = [
        ...
        *_notebook_package_prelude(package_root),
        ...
        "from pathlib import Path as _RmcPath",
        "import pandas as _rmc_pd",
        "from riskmodel_checker.output.excel import write_validation_excel as _rmc_write_validation_excel",
        "from riskmodel_checker.validation.checks import finite_score_series as _rmc_finite_score_series",
        "from riskmodel_checker.validation.config import ValidationConfig as _RmcValidationConfig",
        "from riskmodel_checker.validation.effectiveness import build_effectiveness_result as _rmc_build_effectiveness_result",
        "from riskmodel_checker.validation.effectiveness import compute_bin_tables as _rmc_compute_bin_tables",
        "from riskmodel_checker.validation.effectiveness import compute_monthly_ks as _rmc_compute_monthly_ks",
        "from riskmodel_checker.validation.effectiveness import compute_monthly_psi as _rmc_compute_monthly_psi",
        "from riskmodel_checker.validation.effectiveness import compute_overall_ks as _rmc_compute_overall_ks",
        "from riskmodel_checker.validation.effectiveness import compute_overall_psi as _rmc_compute_overall_psi",
        "from riskmodel_checker.validation.effectiveness import compute_psi_stability_table as _rmc_compute_psi_stability_table",
        "from riskmodel_checker.validation.effectiveness import compute_roc_ks_curves as _rmc_compute_roc_ks_curves",
        "from riskmodel_checker.validation.effectiveness import prepare_effectiveness_context as _rmc_prepare_effectiveness_context",
        "from riskmodel_checker.validation.engine import _filter_feature_categories as _rmc_filter_feature_categories",
        "from riskmodel_checker.validation.engine import _model_features as _rmc_model_features",
        "from riskmodel_checker.validation.in_memory_scores import load_code_model_scores as _rmc_load_code_model_scores",
        "from riskmodel_checker.validation.results import ValidationResults as _RmcValidationResults",
        "from riskmodel_checker.validation.results import ConsistencyStatus as _RmcConsistencyStatus",
        "from riskmodel_checker.validation.results import ConsistencySummary as _RmcConsistencySummary",
        "from riskmodel_checker.validation.results import ReproducibilityResult as _RmcReproducibilityResult",
        "from riskmodel_checker.validation.results import ScoreCompareRow as _RmcScoreCompareRow",
        "from riskmodel_checker.validation.sample_stats import run_basic_info as _rmc_run_basic_info",
        "from riskmodel_checker.validation.stress_test import load_feature_categories as _rmc_load_feature_categories",
        "from riskmodel_checker.validation.stress_test import run_stress_test as _rmc_run_stress_test",
        f"_rmc_payload = {_json_literal(payload)}",
    ...
    score_lines = [
        "# Injected by riskmodel_checker v3 (metrics score).",
    ...
    basic_lines = [
        "# Injected by riskmodel_checker v3 (metrics basic info).",
    ...
    ks_lines = [
        "# Injected by riskmodel_checker v3 (metrics KS).",
    ...
    psi_lines = [
        "# Injected by riskmodel_checker v3 (metrics PSI).",
    ...
    binning_lines = [
        "# Injected by riskmodel_checker v3 (metrics binning).",
    ...
    stress_lines = [
        "# Injected by riskmodel_checker v3 (metrics stress).",
    ...
    output_lines = [
        "# Injected by riskmodel_checker v3 (metrics output).",
