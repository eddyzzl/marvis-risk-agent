...
def build_contract_head_cell_source(
    *,
    ...
    lines = ["# Injected by riskmodel_checker v3 (head). Original notebook unchanged."]
...
def build_contract_tail_cell_source() -> str:
    return r'''
# Injected by riskmodel_checker v3 (tail). Validates the notebook contract.
import json as _rmc_json
from pathlib import Path as _RmcPath
import numpy as _rmc_np
import pandas as _rmc_pd
from riskmodel_checker.model_algorithms import normalize_algorithm as _rmc_normalize_algorithm
