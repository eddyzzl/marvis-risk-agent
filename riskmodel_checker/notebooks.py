...
from riskmodel_checker.notebook_steps import NotebookStepPlan, notebook_step_plan
...
def prepare_execution_notebook_v3(
    *,
    ...
    head.metadata["riskmodel_checker"] = "head"
    tail = nbformat.v4.new_code_cell(build_contract_tail_cell_source())
    tail.metadata["riskmodel_checker"] = "tail"
