...
def _build_stress_scenario_score_cell_sources(
    *,
    ...
    lines = [
        ...
        "for _, _rmc_row in _rmc_dictionary.iterrows():",
        "    _rmc_feature_categories.setdefault(str(_rmc_row[_rmc_category_col]), []).append(str(_rmc_row[_rmc_feature_col]))",
        "_rmc_model_features = []",
        ...
        "    _rmc_model_features = [str(value) for value in _rmc_importance['feature'].tolist()]",
        "if _rmc_model_features:",
        "    _rmc_allowed = set(_rmc_model_features)",
        "    _rmc_feature_categories = {",
        "        category: [feature for feature in features if feature in _rmc_allowed]",
        "        for category, features in _rmc_feature_categories.items()",
        "        if [feature for feature in features if feature in _rmc_allowed]",
        "    }",
        "_rmc_categories = []",
