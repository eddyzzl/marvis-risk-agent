    ...
    *,
    ...
    prepare_lines = [
        ...
        *_notebook_package_prelude(package_root),
        ...
        "from marvis.validation.results import validation_results_to_dict as _rmc_validation_results_to_dict",
    ...
    output_lines = [
        ...
        "    _rmc_json.dumps(_rmc_validation_results_to_dict(_rmc_results), ensure_ascii=False, indent=2),",
        "    encoding='utf-8',",
        ")",
