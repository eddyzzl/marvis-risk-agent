    ...
    *,
    ...
    prepare_lines = [
        ...
        *_notebook_package_prelude(package_root),
        ...
        "from marvis.validation.stress_test import _filter_feature_categories as _rmc_filter_feature_categories",
        "from marvis.validation.stress_test import _model_features as _rmc_model_features",
