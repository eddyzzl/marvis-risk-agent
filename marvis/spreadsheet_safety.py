"""Neutral safety boundary for text written to spreadsheet formats."""
...
def looks_like_excel_formula(value: str) -> bool:
    """Detect formula prefixes after all Excel-ignored leading characters."""
