...
- Partial: split `db.py` schema/connection setup into `marvis/db_schema.py`; `StrategyRepository` now lives in `marvis/repositories/strategy.py`; remaining repositories still need module extraction.
