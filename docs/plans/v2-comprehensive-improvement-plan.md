...
3. Visual tokens are partial, not a system.
   ...
   - Fix:
     ...
     - Done for generic download actions, send-stop composer controls, disabled/focus states, user-message composer bubbles, and agent code-highlight colors.
...
- Mostly done: implement semantic task/surface/status, metric/report/chart, modeling setup/delivery state tokens, generic download/composer action tokens, agent code-highlight tokens, and extract theme controller; older non-modeling utility/settings tokens remain.
