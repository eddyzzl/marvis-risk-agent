...
3. Finish modeling productization with real-task approval-package evidence, richer scorecard policy enforcement, and end-to-end manual smoke on real task data.
