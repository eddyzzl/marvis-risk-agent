...
4. G5 post-training closure is not a workflow.
   ...
   - Fix:
     ...
     - Remaining:
       ...
       - expand native/unsupported exporter edge-case fixtures beyond the current PMML-compatible and calibrated-model paths.
