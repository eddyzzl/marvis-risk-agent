...
3. Finish modeling productization with real-task browser/manual smoke, prior-champion challenger comparison, and final model-card/export polish. JSON and Markdown approval packages now carry selected-model, selection policy, monitoring policy, metric, feature, and delivery evidence, and G5 can create a PMML-backed challenger/backtest validation task package.
...
3. G4 model selection is automatic.
   ...
   - Fix:
     ...
     - Remaining: add prior-champion comparison and real-task manual smoke.
