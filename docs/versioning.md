...
- **V1.0.x**：当前稳定模型验证工作流。
- **V1.1**：计划中的 Agent Memory Foundation，仍属于 V1 产品线。
...
- `V1.1.0`：加入 Agent Memory Foundation 的 V1 minor 版本。
...
1. **保持 V1 稳定**
   ...
   V1.0.x 和 V1.1 用于演示稳定性、bugfix、兼容性、Agent 记忆和低风险增强。不要把未稳定的 V2 plugin/runtime 架构混入 V1 稳定线。
