<p align="center">
  <img src="marvis/static/brand/marvis-logo.png" alt="MARVIS-全能信贷风控智能体 logo" width="148" />
</p>
...
MARVIS-全能信贷风控智能体面向需要本地文件、本地运行环境和可审计证据的信贷风控工作，覆盖模型开发、模型验证、数据处理、特征衍生、特征分析、策略生成、策略验证、监控和受控任务自动化。
